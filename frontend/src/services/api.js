...
export const documentAPI = {
  ...
  searchDocuments: (userId, keyword) => api.get(`/documents/user/${userId}/search?keyword=${keyword}`),
  ...
  toggleBookmark: (documentId, userId) => api.put(`/documents/${documentId}/bookmark?userId=${userId}`),
  
  deleteDocument: (documentId, userId) => api.delete(`/documents/${documentId}?userId=${userId}`),
