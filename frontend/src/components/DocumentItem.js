...
// Import documentAPI để gọi hàm download mới
        ...
        <div style={{
            ...
            <div style={{ flex: '1 1 70%' }}>
                ...
                <p style={{ margin: '5px 0 0 0', fontSize: '0.9em', color: '#6c757d' }}>
                    {getFileIcon(doc.fileType)} | Kích thước: <strong>{getFileSize(doc.fileSize)}</strong> | Môn học: {doc.subjectName || 'Chưa liên kết'}
                </p>
